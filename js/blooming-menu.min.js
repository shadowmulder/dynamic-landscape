...
;(function () {
    ...
    BloomingMenu.prototype.open = function () {
      ...
      this.props.elements.container.style.zIndex = "4";
      return this
    }
    ...
    BloomingMenu.prototype.close = function () {
      ...
      this.props.elements.container.style.zIndex = "2";
      return this
    }
    ...
    BloomingMenu.prototype.setPos = function (x,y) {
        this.props.elements.container.style.position = "absolute";
        this.props.elements.container.style.top = y+"px";
        this.props.elements.container.style.left = x+"px";
    }

    BloomingMenu.prototype.isOpen = function (){
    ...
    function createElements (props) {
      ...
      //props.elements.container.id = "menu"
      ...
      props.elements.main = document.createElement('span')
  ...
  /*
      ...
      cssRules +=
        ...
        '  width: 100%;' +
        '  height: 100%;' +
        '  background-color: rgba(68, 149, 255, 0.8);' +
        '  border-radius: 50%;' +
